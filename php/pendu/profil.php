...
<body>
    ...
    <main>
        ...
        <h2>Remplissez les champs que vous souhaitez modifier</h2>
        <h3>
           <?php 
                if(isset($_POST['profil_change'])) { 
                        echo $message_profil;
...
<!-- infos des values récupérées grâce à ma requête sql du haut de la page -->
            ...
            <label for="mdp" class="form_label">Tapez votre ancien mot de passe pour confirmer les changements</label>
